  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="p-2.5 md:p-3 text-gray-400 hover:text-white hover:bg-neutral-900 rounded-[var(--border-radius)] transition-all duration-150 relative group order-4 md:order-5"
      ...
      <button
        ...
        className="p-2.5 md:p-3 text-gray-400 hover:text-white hover:bg-neutral-900 rounded-[var(--border-radius)] transition-all duration-150 order-5 md:order-6"
      >
      ...
      <button
        ...
        className="hidden md:block p-3 text-gray-400 hover:text-[var(--color-danger)] hover:bg-neutral-900 rounded-[var(--border-radius)] transition-all duration-150 order-8 md:order-8"
      >
